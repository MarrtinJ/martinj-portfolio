...
const ProjectCard = ({ index, name, description, tags, image, source_code_link, doc_link }) => {
  return (
        ...
        <div className='relative w-full h-[230px]'>
          ...
          >
            ...
            <div
              ...
              className={`${!source_code_link ? "hidden" : "black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"}`}
            >
              <img
                src={github}
                alt="github"
    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          links to code repositories, technical reports, or live demos where applicable.
        </motion.p>
      </div>
